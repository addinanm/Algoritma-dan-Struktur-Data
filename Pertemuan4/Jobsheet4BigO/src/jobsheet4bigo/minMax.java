    ...
    public static void max_min(int [] arr, int indeks_awal, int indeks_akhir, Maxmin hasil){
        ...
        if(indeks_awal == indeks_akhir){
            ...
            if (arr[indeks_awal]>arr[indeks_akhir]) {
                hasil1.minimum = arr[indeks_akhir];
                hasil1.maximum = arr[indeks_awal];
            }else {
                hasil2.minimum = arr[indeks_awal];
                hasil2.maximum = arr[indeks_akhir];
            }
        }else {
            ...
            hasil.minimum = (hasil.minimum < hasil2.minimum) ? hasil.minimum : hasil2.minimum;
            hasil.maximum = (hasil.minimum > hasil2.minimum) ? hasil.minimum : hasil2.minimum;
